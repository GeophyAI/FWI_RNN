...
class WaveRNN(torch.nn.Module):
    ...
    def forward(self, x, output_fields=False, save_plot = True):
        ...
        if save_plot:
            for i, img in enumerate(imgs):
                plt.imsave('/home/wangsw/Desktop/code/AI/_pycuda/wavetorch/imgs/img%03d.jpg'%(i), img, cmap = plt.cm.gray)
        return y
