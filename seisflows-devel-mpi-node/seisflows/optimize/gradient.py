    ...
    ***
    ...
    def __init__(self, line_search_method="bracket",
        ...
        self._acceptable_vectors = ["m_new", "m_old", "m_try",
                                    "g_new", "g_old", "g_try",
                                    "p_new", "p_old", "alpha",
                                    "f_new", "f_old", "f_try", "alpha_customer"]
    ...
    def initialize_search(self):
        ...
        if self.line_search_method.upper() == "Customer".upper():
            alpha, _ = self._line_search.calculate_step_length(m.vector, g.vector)
        else:
    ...
    def update_line_search(self):
        ...
        if self.line_search_method.upper() == "Customer".upper():
            logger.info("line search with Customer")
            alpha = alpha_try*self.load_vector("alpha_customer")
            status = "PASS"
        else:
